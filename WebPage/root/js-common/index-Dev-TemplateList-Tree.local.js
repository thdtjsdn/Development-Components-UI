//----------------------------------------------------------------------------------------------------;
var fileNm = "js-common/index-Dev-TemplateList-Tree.local.js";
...
return el;})().onload = function(){ window.console.log( "Initialize Libraries Complete." );
	...
	(function(){
		...
		window.apis.util.importHTMLJS__And_Add_b2link_STATIC_UI(
			"/ui/App/TemplateList/index-Fancytree"
			, host + "/ui/App/TemplateList/index-Fancytree.html"
			, host + "/ui/App/TemplateList/index-Fancytree.js"
			, window.apis.ui.APPEND_CHILD_TARGET_ELEMENT_ID
		);
	})();
