//----------------------------------------------------------------------------------------------------;
var fileNm = "js-common/index-Dev-MongoDBQueryTester.js";
...
return el;})().onload = function(){ window.console.log( "Initialize Libraries Complete." );
	...
	(function(){
		...
		window.apis.util.importHTMLJS__And_Add_b2link_STATIC_UI(
			"/ui/App/MongoDBQueryTester/index"
			, host + "/ui/App/MongoDBQueryTester/index.html"
			, host + "/ui/App/MongoDBQueryTester/index.js"
