window.__defineGetter__( "isPopup", function(){ return true; } );
//----------------------------------------------------------------------------------------------------;
var fileNm = "js-common/index-popup.common.js";
 ...
 * @example
 * <code>
	http://localhost:49321/index-popup.html?api=window.ui_member.public.forgotPassword.modal({ display : false })
 * </code>
 */
...
return el;})().onload = function(){ window.console.log( "Initialize Libraries Complete." );
	...
	var f0 = window.apis.element.mouseDisable__ID;
	var f1 = window.apis.element.mouseEnable__ID;
	...
	//window.apis.ui.set_APPEND_CHILD_TARGET_ELEMENT( "div_0__UI_Component_Fixed" );

	/*///----------[ S ] - HTML, JavaScript UI;
	try
	{
		//window.location 에서 Parameter를 추출한다.;
		var urlParams = window.apis.location.get__api_params_SCODE();
		//"window.ui_member.public.forgotPassword" 같은 문자열 API를 호출하다.;
		var ui = window.apis.common.execStringAPI( urlParams.api, urlParams.params );
		var el = ui[ 0 ];
		var elc = ui[ 1 ];
	}
	catch( e )
	{
		window.TtwLog.error( "index-popup.html Error : " + e );
		debugger;
	}
	...
	/*/
	window.apis_service.common._fn_res = window.apis_service.common._fn_authRes;
	window.apis_service.common._fn_res__locale_label = window.apis_service.common._fn_authRes__locale_label;
	window.apis_service.common._fn_res_for_string_result = window.apis_service.common._fn_authRes_for_string_result;
	window.apis_service.common._fn_res_for_string_result__locale_label = window.apis_service.common._fn_authRes_for_string_result__locale_label;
	window.apis_service.common._fn_res_POST = window.apis_service.common._fn_authRes_POST;
	//*/
...
window[ "__INITIALIZE-PACKAGE__" ] = function( e, t )
{
	...
	(function(){ var _fn = window.apis.url.getServerURL_WebServer_SCODE; window.apis.url.getServerURL_WebServer_SCODE = function( SCODE ){
	...
	//window._$TATIC_CONST_DEBUG ? e( "./js__SYS0015/" ) : f( "./js__SYS0015/___merge_min_all_1_0.js" );
	...
	window.apis.event.__initialize_Events();
	//*/
