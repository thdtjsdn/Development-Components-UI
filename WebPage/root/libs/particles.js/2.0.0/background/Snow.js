//window.b2link.util.importJS( window.b2link.url.getServerURL_WebServer_SCODE( "SYS0015" ) + "/libs/particles.js/2.0.0/background/Snow.js" );
//setTimeout( function(){ window.b2link.util.importJS( window.b2link.url.getServerURL_WebServer_SCODE( "SYS0015" ) + "/libs/particles.js/2.0.0/background/Snow.js" ); }, 5000 );
(function(){
	try
	{
		var host = "";
		...
		window.b2link.STATIC.CONST.ROOT_DIV.EL_TOP_MODAL.insertAdjacentHTML( "afterend"
			, '<IFRAME style="width: 100%; height: 100%; position: absolute; left: 0px; top: 0px; right: 0px; bottom: 0px; overflow: hidden !important; pointer-events: none !important;" src="'
				+ host
				+ '/libs/particles.js/2.0.0/background/Snow.html"></IFRAME>'
		);
	}
	catch( e )
	{
